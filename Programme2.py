...
# Couleurs vertes, jaunes et bleues
colors = ['green', 'yellow', 'blue']
explode = (0, 0, 0)
plt.pie(data, explode=explode, labels=name, autopct='%1.1f%%', startangle=90, shadow=True, wedgeprops=dict(width=0.4), colors=colors)
plt.axis('equal')
...
explode = (0, 0)
plt.pie(data2, explode=explode, labels=name2, autopct='%1.1f%%', startangle=90, shadow=True, wedgeprops=dict(width=0.4), colors=colors2)
...
<html lang="fr">
   <head>
      ...
      <style>
      body {
          background-image: url('https://www.google.com/url?sa=i&url=https%%3A%%2F%%2Fwww.codeur.com%%2Fblog%%2Fpage%%2F9&psig=AOvVaw2-F5NDVWh-baHQQ_zdnHFz&ust=1705947787993000&source=images&cd=vfe&opi=89978449&ved=0CBIQjRxqFwoTCJD5k_SM74MDFQAAAAAdAAAAABAI');
...
with open('donns.csv', 'w', newline='') as fichiercsv:
...
with open('Stat.csv', 'w', newline='') as fichier2:
